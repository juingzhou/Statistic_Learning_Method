...
def getAllProbability(trainDataArr, trainLabelArr):
    ...
    :return: 返回训练集的先验概率分布和条件概率分布
    '''
    # 设置特征数目, 数据集中手写图片为28*28=784, 转换为向量是784维
...
if __name__ == '__main__':
    ...
    trainDataArr, trainLabelArr = loadData('transmnist/Mnist/mnist_train.csv')

    # 获取测试集
    print('start read testSet')
    testDataArr, testLabelArr = loadData('transmnist/Mnist/mnist_test.csv')
